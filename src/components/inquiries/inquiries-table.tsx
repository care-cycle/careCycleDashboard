          ...
          {inquiries.length > 0 ? (
            inquiries.map((inquiry) => (
              ...
              >
                <TableCell>
                  <div className="h-8 w-8 flex items-center justify-center">
                    <PhoneForwarded 
                      ...
                      onClick={(e) => handleCallsNavigation(e, inquiry.callerId)}
                    />
                  </div>
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <div className="flex flex-col">
                    <span className="font-medium">{inquiry.carrierName || '-'}</span>
                    <span className="text-sm text-gray-500">{inquiry.planName || '-'}</span>
                  </div>
                </TableCell>
