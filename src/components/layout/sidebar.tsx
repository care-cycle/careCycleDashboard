import { LayoutDashboard, Phone, GitBranch, Users, CircuitBoard, RotateCw, Megaphone, Calendar, Settings, MessageSquare, ChevronLeft, ChevronRight } from "lucide-react"
    ...
    <div className="relative h-full">
      ...
      >
                        ...
                        {item.badge && (
                          <Badge 
                            ...
                            className={cn(
                              ...
                              item.disabled ? "bg-gray-100/50 text-gray-500" : "bg-secondary/10 text-secondary"
                            )}
                          >
                            {item.badge}
                          </Badge>
        ...
        <div className="px-2 mb-4">
          ...
          >
            <div className="relative flex items-center w-[260px]">
              <RotateCw className={cn("h-4 w-4 absolute left-[15px]", isRefreshing && "animate-spin")} />
              <span className={cn(
